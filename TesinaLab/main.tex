...
\subsubsection{File e strutture dati per il controllo}
...
\noindent\textbf{Parametri dell'encoder} \\
...
\noindent\textbf{Struttura dati dello stato del veicolo} \\
...
\section{Implementazione del Controllo dello Sterzo}
...
\subsubsection{Configurazione del Timer per l'attuazione dello sterzo (PWM)}
...
\subsubsection{Calibrazione meccanica dello sterzo}
